...
class HomeFragment : Fragment() {
    ...
    private fun initRv() {
        ...
        wisdomExchangeRvAdapter.add(WisdomExchange("", "슬기 교환서 제목", "프로그래밍", "아트",
            arrayListOf("C++", "Python"), arrayListOf("디자인", "영상"), 4.0, 123, 123))
        wisdomExchangeRvAdapter.add(WisdomExchange("https://i.imgur.com/58e6sXz.jpg", "슬기 제목0", "내 슬기들0", "희망 슬기들0",
                arrayListOf(), arrayListOf(), 0.0, 0, 0))
        wisdomExchangeRvAdapter.add(WisdomExchange("https://i.imgur.com/RpMDsuF.jpg", "슬기 제목1", "내 슬기들1", "희망 슬기들1",
                arrayListOf("내 슬기"), arrayListOf(), 1.1, 1, 1999))
        wisdomExchangeRvAdapter.add(WisdomExchange("https://i.imgur.com/q3ZKiTw.jpg", "슬기 제목2", "내 슬기들2", "희망 슬기들2",
            arrayListOf(), arrayListOf("희망슬기1", "희망슬기2"), 4.4, 99999, 9))
        wisdomExchangeRvAdapter.add(WisdomExchange("https://i.imgur.com/WMrDqWz.jpg", "슬기 제목3", "내 슬기들3", "희망 슬기들3",
            arrayListOf("내 슬기1", "내 슬기2"), arrayListOf("희망슬기"), 3.56, 413, 53))
        wisdomExchangeRvAdapter.add(WisdomExchange("https://i.imgur.com/SIquQS2.jpg", "슬기 제목4", "내 슬기들4", "희망 슬기들4",
            arrayListOf(), arrayListOf("희망슬기1234"), 2.7, 10, 2))
        wisdomExchangeRvAdapter.add(WisdomExchange("https://i.imgur.com/lRDCzkG.jpg", "슬기 제목5", "내 슬기들5", "희망 슬기들5",
            arrayListOf("내 슬기"), arrayListOf("희망 슬기"), 5.0, 5, 5))
        wisdomExchangeRvAdapter.add(WisdomExchange("https://i.imgur.com/BWNpfGp.jpg", "슬기 제목6", "내 슬기들6", "희망 슬기들6",
                arrayListOf(), arrayListOf(), 1.8, 3576, 444))
