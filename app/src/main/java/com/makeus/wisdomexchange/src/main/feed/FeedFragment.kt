...
class FeedFragment : Fragment() {
    ...
    private fun initRv(view: View) {
        ...
        feedRvAdapter.add(Feed(4, "익명", "Lorem ipsum d   olor sit amet, consectetur adipis elit, sed do eiusmod tempor incididunt", "오전 12:00", null, 0, 0))
        ...
        feedRvAdapter.add(Feed(13, "익명", "Lorem ipsum dolor sit amet, consectetur adipis elit, sed do eiusmod tempor incididunt", "오전 12:00", "http://ram.komica2.net/00/src/1601988501524.jpg", 0, 0))
        feedRvAdapter.add(Feed(14, "익명", "Lorem ipsum dolor sit amet, consectetur adipis elit, sed do eiusmod tempor incididunt Lorem ipsum dolor sit amet, consectetur adipis elit, sed do eiusmod tempor incididunt",  "오전 12:00", "http://ram.komica2.net/00/src/1601988443862.jpg", 0, 0))
        ...
        feedRvAdapter.add(Feed(16, "익명", "Lorem ipsum dolor sit amet, consectetur adipis elit, sed do eiusmod tempor incididunt Lorem ipsum dolor sit amet, consectetur adipis elit, sed do eiusmod tempor incididunt", "오전 12:00", "https://post-phinf.pstatic.net/MjAyMDA4MjVfMTY1/MDAxNTk4MzUyMzg5MDk5.uSx55RCqy1yzbFcvGVTdbA1ZWoeZGeMpVMyuvyVDIEYg.h36_s8YhaD4tKTma30yTw6e_QoP4SKJ52C1OZeGcB2Eg.JPEG/IMG_5471.jpg", 0, 0))
    }
